...
def test_DARCDesign_default_instantiation():
    design_thing = darc.designs.BADDesignGenerator(RA=list(100*np.linspace(0.05, 0.95, 91)))
    assert isinstance(design_thing, darc.designs.BADDesignGenerator)
...
def test_DARCDesign_delay_instantiation():
    design_thing = darc.designs.BADDesignGenerator(max_trials=3,
